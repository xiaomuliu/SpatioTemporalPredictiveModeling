DROP TABLE X_Narcotics_Pts_08_14;

CREATE TABLE X_Narcotics_Pts_08_14
(
DATEOCC DATE, 
YEAR VARCHAR2(4),
MONTH VARCHAR2(2),
...
INSERT INTO X_Narcotics_Pts_08_14(DATEOCC,YEAR,MONTH,DAY,CURR_IUCR,FBI_CD,AREA,BEAT,DISTRICT,X_COORD,Y_COORD,LOCATION,INC_CNT)
...
AND (CITY='CHICAGO') 
AND (CURR_IUCR LIKE '18__'
OR CURR_IUCR LIKE '20__'
OR CURR_IUCR LIKE '21__')
