--DROP TABLE X_AggAssault_Pts_08_14;

CREATE TABLE X_AggAssault_Pts_08_14
(
DATEOCC DATE, 
YEAR VARCHAR2(4),
MONTH VARCHAR2(2),
...
INSERT INTO X_AggAssault_Pts_08_14(DATEOCC,YEAR,MONTH,DAY,CURR_IUCR,FBI_CD,AREA,BEAT,DISTRICT,X_COORD,Y_COORD,LOCATION,INC_CNT)
...
AND (CITY='CHICAGO') 
AND (CURR_IUCR IN ('051A','051B','0520','0530','0550','0551','0552','0553','0555','0556','0557',
                   '0558')
    )
