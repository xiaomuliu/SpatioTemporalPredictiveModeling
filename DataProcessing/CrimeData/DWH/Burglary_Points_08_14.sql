DROP TABLE X_Burglary_Pts_08_14;

CREATE TABLE X_Burglary_Pts_08_14
(
DATEOCC DATE, 
YEAR VARCHAR2(4),
MONTH VARCHAR2(2),
...
INSERT INTO X_Burglary_Pts_08_14(DATEOCC,YEAR,MONTH,DAY,CURR_IUCR,FBI_CD,AREA,BEAT,DISTRICT,X_COORD,Y_COORD,LOCATION,INC_CNT)
...
AND (CITY='CHICAGO') 
AND (CURR_IUCR IN ('0610','0620','0630','0650'))
