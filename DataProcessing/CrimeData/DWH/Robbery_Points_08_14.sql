DROP TABLE X_Robbery_Pts_08_14;

CREATE TABLE X_Robbery_Pts_08_14
(
DATEOCC DATE, 
YEAR VARCHAR2(4),
MONTH VARCHAR2(2),
...
INSERT INTO X_Robbery_Pts_08_14(DATEOCC,YEAR,MONTH,DAY,CURR_IUCR,FBI_CD,AREA,BEAT,DISTRICT,X_COORD,Y_COORD,LOCATION,INC_CNT)
...
AND (CITY='CHICAGO') 
AND (CURR_IUCR IN ('0312','0313','031A','031B','0320','0325','0326','0330','0331','0334','0337',
                   '033A','033B','0340'))
