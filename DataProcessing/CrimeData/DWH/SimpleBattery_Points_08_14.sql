--DROP TABLE X_SimBattery_Pts_08_14;

CREATE TABLE X_SimBattery_Pts_08_14
(
DATEOCC DATE, 
YEAR VARCHAR2(4),
MONTH VARCHAR2(2),
...
INSERT INTO X_SimBattery_Pts_08_14(DATEOCC,YEAR,MONTH,DAY,CURR_IUCR,FBI_CD,AREA,BEAT,DISTRICT,X_COORD,Y_COORD,LOCATION,INC_CNT)
...
AND (CITY='CHICAGO') 
AND (CURR_IUCR IN ('0440','0454','0460','0475','0484','0486','0487','0494'))
