...
-- DROP TABLE X_All_Violent_01_14;

CREATE TABLE X_All_Violent_01_14
(
DATEOCC DATE, 
YEAR VARCHAR2(4),
MONTH VARCHAR2(2),
...
INSERT INTO X_All_Violent_01_14(DATEOCC,YEAR,MONTH,DAY,CURR_IUCR,FBI_CD,AREA,BEAT,DISTRICT,X_COORD,Y_COORD,LOCATION,INC_CNT)
SELECT DATEOCC, YEAR, MONTH, DAY, CURR_IUCR, FBI_CD, AREA, BEAT, DISTRICT, INC_CNT
